...
SECRET_KEY = "django-insecure-j0$pau&7wyo_da3!gxlpc&85l*_svjk5$0f+fcjq45ku7lr5f6"
...
# Assuming your React build is in '/path/to/your/react/app/build'
...
# The rest of your static settings
STATIC_URL = '/static/'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'sslmode': 'require',
            'sslrootcert': os.getenv('DB_SSL_ROOT_CERT_PATH'),
        }
    }
}
