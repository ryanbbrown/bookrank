        ...
        <div className="relative">
            ...
            <div className="flex flex-col items-center text-center relative px-6 py-20 mx-auto">
                <div className="py-20 flex flex-col items-center text-center w-[95%] xl:w-[65%] relative">
                    ...
                    <p className="mt-6 text-lg md:text-xl text-gray-600 max-w-xl">
                        Rank books intuitively and receive recommendations
                        tailored to <span className="font-bold">your</span>{" "}
                        library, powered by AI.
                    </p>
                    <Button
            ...
            <div className="pt-[30vh] px-6">
                <div className="max-w-4xl mx-auto text-center mb-12">
                    ...
                    <p className="mt-4 text-gray-600">
                        BookRank offers unique features to help you discover
                ...
                <div className="container mx-auto w-full sm:w-4/5 xl:w-full 2xl:w-4/5 grid grid-cols-1 xl:grid-cols-3 gap-12">
                    <Card className="bg-white">
                        <CardContent className="p-6">
                            ...
                            <p className="text-gray-600">
                                1-5 stars is limiting, but choosing a more
                                specific rating is hard. Just decide between
                                pairs of books and let our algorithm do the
                                rest.
                            </p>
                        </CardContent>
                    </Card>
                    <Card className="bg-white">
                        <CardContent className="p-6">
                            ...
                            <p className="text-gray-600">
                                Receive personalized book recommendations that
                                learn from your preferences, based on the actual
                                content of your favorite books.
                            </p>
                        </CardContent>
                    </Card>
                    <Card className="bg-white">
                        <CardContent className="p-6">
                            ...
                            <p className="text-gray-600">
                                Easily import your reading history for a
                                seamless transition. No more frustration with
                                Goodread's clunky interface and generic book
                                recs.
                            </p>
                        </CardContent>
                    </Card>
            ...
            <div className="pt-40 px-6">
                <div className="w-full sm:w-2/3 mx-auto text-center mb-12">
                    ...
                    <p className="mt-4 text-gray-600">
                        We could tell you that it absolutely is, but we'll let
                ...
                <div className="flex items-center justify-center">
                    <div className="bg-homepage-blue mb-20 w-4/5 2xl:w-2/3 md:h-60 p-8 rounded-[12px] flex md:flex-row flex-col justify-between items-center text-white shadow-lg">
                        ...
                        <div className="flex-1 text-center">
                            ...
                            <p className="mt-2">
                                users would recommend <br /> over Goodreads{" "}
                            </p>
                        </div>
                    </div>
                </div>
